...
export const CONTENT_PRODUCTS: ContentProductSchema[] = [
  ...
  },
  {
    ...
    tagline: 'Regional brackets — exclusivity, crunch, regional pride, hot takes.',
    gumroadCategory: 'Creator Tools',
    platforms: ['instagram', 'tiktok', 'x'],
    reelHooks: [
      'Every region thinks THEIR gas station snack is undefeated',
      'Most snack rankings are vibes — this one scores exclusivity first',
      'Wildcard slot for the chain item that hits too hard',
    ],
    captionTone: 'Hot take, road-trip energy, receipt-ready',
    vaultFolder: 'vault/sprint-2-gas-station',
    notionTemplateId: 'brief-sprint-2-gas-station',
    buildOutputs: ['Ranking PDF', 'Gumroad copy', 'Receipt template', '3 Reel scripts'],
    launchOutputs: ['3 Reel scripts', '3 captions', 'Day review → Chaos Ledger'],
    receiptMetric: 'downloads_and_engagement',
  },
  {
    slug: 'sprint-3-too-late',
    name: 'Is It Too Late to Reply? Flowchart',
    tagline: 'Time since text → exact verdict. Escalating self-deprecation included.',
    gumroadCategory: 'Productivity',
    platforms: ['instagram', 'x', 'tiktok'],
    reelHooks: [
      'Read at 2pm. Replied at midnight. Was that insane?',
      '24–72 hours? There\'s a script for that.',
      'Worst-case branch + Day Review',
    ],
    captionTone: 'Self-deprecating, relatable, flowchart-forward',
    vaultFolder: 'vault/sprint-3-too-late',
    notionTemplateId: 'brief-sprint-3-too-late',
    buildOutputs: ['Flowchart PDF', 'Gumroad copy', 'Receipt template'],
    launchOutputs: ['3 Reel scripts', '3 captions', 'Day review checklist'],
    receiptMetric: 'downloads',
  },
  {
    slug: 'gas-station',
    name: 'Gas Station Snack Rankings',
    tagline: 'Alias → sprint-2-gas-station',
    gumroadCategory: 'Creator Tools',
    platforms: ['instagram', 'tiktok', 'x'],
    reelHooks: ['Regional snack brackets'],
    captionTone: 'Hot take',
    vaultFolder: 'vault/sprint-2-gas-station',
    notionTemplateId: 'brief-sprint-2-gas-station',
    buildOutputs: ['Ranking PDF'],
    launchOutputs: ['3 Reel scripts'],
    receiptMetric: 'downloads',
  },
  {
